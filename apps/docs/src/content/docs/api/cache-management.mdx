...
- `modelId` - MLC model identifier (e.g., `'Qwen3-8B-q4f16_1-MLC'`)
...
function CacheDashboard() {
  ...
  async function loadCacheStatus() {
    const models = [
      { model: 'Qwen3-8B-q4f16_1-MLC', size: 6000 },
...
// Usage
let client = await switchModel(null, 'Qwen3-8B-q4f16_1-MLC');

// Later: switch to smaller model and delete old one
const oldModel = 'Qwen3-8B-q4f16_1-MLC';
