...
|-------|------------|-----------------|---------------|------------|
| **S** | ≥8192 MB | High-end desktop GPUs (RTX 3080+, M2 Max+) | Qwen3-8B-q4f16_1-MLC | ~5.5 GB |
| **A** | ≥4096 MB | Mid-range GPUs (RTX 3060, M1/M2 Pro, iPad Pro) | Qwen3-8B-q4f16_1-MLC | ~5.5 GB |
| **B** | ≥2048 MB | Entry-level GPUs (Integrated Intel/AMD, M1 base) | Qwen2.5-3B-Instruct-q4f16_1-MLC | ~2.2 GB |
...
// S/A grade → Qwen3-8B-q4f16_1-MLC
// B grade   → Qwen2.5-3B-Instruct-q4f16_1-MLC
...
const client = createClient({
  local: {
    tiers: {
      ...
      medium: 'Qwen3-8B-q4f16_1-MLC',   // For B grade
...
const client = createClient({
  local: {
    tiers: {
      high: 'Qwen3-8B-q4f16_1-MLC',   // Quality focus
      medium: 'Qwen2.5-3B-Instruct-q4f16_1-MLC', // Balanced
